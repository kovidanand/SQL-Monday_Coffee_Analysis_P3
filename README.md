...
![image](https://github.com/kovidanand/SQL-Monday_Coffee_Analysis_P3/blob/main/1.png)

## Objective
The goal of this project is to analyze the sales data of Monday Coffee, a company that has been selling its products online since January 2023, and to recommend the top three major cities in India for opening new coffee shop locations based on consumer demand and sales performanc

## Database Setup

![image](https://github.com/kovidanand/SQL-Monday_Coffee_Analysis_P3/blob/main/ERD.png)
